...
const Projects = () => {
  ...
  <div className="w-full flex flex-row">
    <div className="w-1/2"><p className="px-10 py-5 text-[length:var(--text-size-heading-2)]  font-bold font-heading-montserrat gradient-text">Latest Projects</p></div>
    <div></div>
  </div>
</div>
...
{PROJECTS?.map((project)=>(
  ...
  <p className='text-[length:var(--size-step-4)] font-heading-lora navLink w-fit hover:gradient-text'>{project.name}</p>
  <p className='text-[length:var(--text-size-base)] text-neutral-200 leading-relaxed font-heading-montserrat'>{project.description}</p>
